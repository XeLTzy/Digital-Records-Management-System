    ...
    <div id="dtop" class="mb-1">
        ...
        <header>
            ...
            <div class="container p-2 mt-1">
                <div class="d-flex flex-column align-items-center gap-1 p-3">
                    <div class=""> <img src="assets/images/Icons/logo-v5.png" alt="Icons" style="height: 90px;"></div>
            ...
            <!-- <div class="col-md-4 d-flex justify-content-center m-auto mt-3 g-2">
                    <img src="assets/images/Icons/logo-v5.png" alt="Icons" style="height: 90px;">
                </div>
                <div class=" col-md-4 d-flex-inline justify-content-center m-auto">
                    <label for="firstname" class="form-label">First Name *</label>
                    <input type="text" class="form-control" id="firstname" name="firstname">
                </div>
                <div class=" col-md-4 d-flex-inline justify-content-center m-auto">
